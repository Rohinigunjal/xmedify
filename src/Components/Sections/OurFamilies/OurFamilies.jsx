      ...
      <Container>
        <Grid container alignItems="center" spacing={{ xs: 2, md: 10 }}>
          <Grid item xs={12} md={6} >
            ...
            <Typography variant="h2" mb={2}>Our Families</Typography>
            <Typography color="#77829D" lineHeight={1.8} width="420px">
          ...
          <Grid item xs={12} md={6}>
            <Box component="img" src={banner} width={350} height="auto"/>
          </Grid>
        </Grid>
      </Container>
    </Box>
